...
// Zod schema for vehicle document form validation
...
type VehicleDocumentFormData = z.infer<typeof vehicleDocumentSchema>;
...
const VehicleDocumentForm = ({ document, isOpen, onClose }: VehicleDocumentFormProps) => {
